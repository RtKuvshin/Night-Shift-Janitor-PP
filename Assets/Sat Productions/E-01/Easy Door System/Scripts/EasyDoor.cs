...
namespace SatProductions
{
    ...
    public class EasyDoor : MonoBehaviour
    {
        ...
        public static EasyDoor Instance { get; private set; }
        ...
        public void OpenDoor(bool isBack)
        {
            if (IsOpen || IsMoving) return;

            Vector3 targetRot = isBack ? -openedRotation : openedRotation;
            Vector3 targetPos = isBack ? -openedPosition : openedPosition;
